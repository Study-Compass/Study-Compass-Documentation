...
const config = {
  ...
  url: 'https://docs.study-compass.com',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/Study-Compass-Documentation/',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          {
            type: 'docSidebar',
            sidebarId: 'documentation1',
            position: 'left',
            label: 'documentation',
          },
          {
            href: 'https://github.com/Study-Compass/Study-Compass-Documentation',
            label: 'GitHub',
            position: 'right',
          },
        ],
